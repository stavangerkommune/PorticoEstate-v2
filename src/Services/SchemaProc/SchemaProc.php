<?php
	...
	*/
	...
	namespace App\Services\SchemaProc;
	/**
	* Database schema abstraction class
	*
	* @package phpgwapi
	...
	*/
	class SchemaProc
	{
		...
		function __construct($dbms)
		{
			...
			{
				case 'mysql':
				$this->m_oTranslator	= new \App\Services\SchemaProc\SchemaProcMysql();
				break;

				case 'postgres':
				$this->m_oTranslator	= new \App\Services\SchemaProc\SchemaProcPgsql();
				break;

				case 'oracle':
				$this->m_oTranslator	= new \App\Services\SchemaProc\SchemaProcOracle();
				break;

				case 'sapdb':
				$this->m_oTranslator	= new \App\Services\SchemaProc\SchemaProcSapdb();
				break;

				case 'mssqlnative':
				case 'mssql':
				$this->m_oTranslator	= new \App\Services\SchemaProc\SchemaProcMssql();
				break;

				default:
				//what now?
			}
			$this->m_oDeltaProc		= new \App\Services\SchemaProc\SchemaProcArray();
