...
class frontend_uicontroller extends frontend_uicommon
{
	...
	public function __construct()
	{
		...
		Translation::getInstance()->add_app('controller');
	}
	...
	{
		$this->apps['manual']['section'] = 'controller.index';
		Settings::getInstance()->update('apps', ['manual' => ['section' => 'controller.index']]);
	...
	public function query()
	{
		...
		foreach ($values as &$entry)
		{
			...
			$entry['completed_date_text'] = $this->phpgwapi_common->show_date($entry['completed_date'], $dateFormat);
