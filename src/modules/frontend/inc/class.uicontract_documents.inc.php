...
class frontend_uicontract_documents extends frontend_uicommon
{
	...
	public function __construct()
	{
		...
		$this->form_url_doc = phpgw::link('/', array(
			'menuaction' => 'frontend.uicontract_documents.index',
			'location_id' => $this->location_id
		));
		Cache::session_set('frontend', 'tab', $this->locations->get_id('frontend', '.document.contracts'));
