		...
		<div class="frontend_content">
			...
			<div id="login-bar">
				<ul class="user_menu">
					<li>
						<em>
							<img src="frontend/templates/base/images/16x16/user_red.png"  class="list_image" />
						</em>
						<xsl:value-of select="name_of_user"/> | <a href="http://portico/pe/preferences/changepassword.php">Bytt passord</a>
					</li>
					<li>
						<a href="{$messages_url}" class="list_image">
							<em>
								<img src="frontend/templates/base/images/16x16/email.png" class="list_image"/>
							</em>
							<xsl:value-of select="new_messages"/>
						</a>
					</li>
					<li>
						...
						|
						<a href="{home_url}"  class="header_link">
							<em>
								<img src="frontend/templates/base/images/16x16/door_open.png" />
							</em>
			...
			<div id="information">
				<ul>
					<li>
						<em>
							<img src="frontend/templates/base/images/16x16/help.png" class="list_image"/>
						</em>
						<a href="{help_url}" class="header_link">
					...
					<li>
						...
						<a href="{contact_url}" class="header_link">
							<xsl:value-of select="php:function('lang', 'contact_BKB')"/>
						</a>
					</li>
					<li>
						<em>
							<img src="frontend/templates/base/images/16x16/page.png" class="list_image"/>
						</em>
						<a href="{folder_url}" class="header_link">
			...
			<div id="area_and_price">
				<ul>
					<li>
						...
						<xsl:value-of select="php:function('lang', 'number_of_units')"/>: <xsl:value-of select="number_of_locations"/>
					</li>
					<li>
						<em>
							<img src="frontend/templates/base/images/16x16/shading.png"  class="list_image"/>
						</em>
						<xsl:value-of select="php:function('lang', 'total_area_internal')"/>: <xsl:value-of select="total_area"/>
					</li>
					<li>
						<em>
							<img src="frontend/templates/base/images/16x16/coins.png" class="list_image"/>
						</em>
						<xsl:value-of select="php:function('lang', 'total_price_internal')"/>: <xsl:value-of select="total_price"/>
					</li>
				</ul>
			</div>
			<xsl:choose>
				...
				<xsl:otherwise>
					<div id="unit_selector">
						<form action="{form_action}" method="post">
							...
							<br/>
							<xsl:variable name="lang_no_name_unit">
								<xsl:value-of select="php:function('lang', 'no_name_unit')"/>
							</xsl:variable>
					...
					<div id="area_and_price2">
						<ul>
							<li style="border-style: none none solid none; border-width: 1px; border-color: grey; padding-bottom: 5px; ">
								<em>
									<img src="frontend/templates/base/images/16x16/house.png" class="list_image"/>
								</em>
								<xsl:value-of select="php:function('lang', 'chosen_unit')"/>:</li>
							<li>
								<em>
									<img src="frontend/templates/base/images/16x16/shading.png"  class="list_image"/>
								</em>
								<xsl:value-of select="php:function('lang', 'total_area_internal')"/>: <xsl:value-of select="selected_total_area"/>
							</li>
							<li>
								<em>
									<img src="frontend/templates/base/images/16x16/coins.png" class="list_image"/>
								</em>
								<xsl:value-of select="php:function('lang', 'total_price_internal')"/>: <xsl:value-of select="selected_total_price"/>
							</li>
						</ul>
					</div>
