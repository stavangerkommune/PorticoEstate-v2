...
class helpdesk_uicat_respond_messages extends phpgwapi_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('helpdesk') . '::' . lang('category respond messages')]);
	...
	public function edit($values = array(), $mode = 'edit', $error = false)
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('helpdesk') . '::' . lang('category respond messages') . '::' . lang($mode)]);
