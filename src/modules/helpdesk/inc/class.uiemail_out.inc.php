...
class helpdesk_uiemail_out extends phpgwapi_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['allow_html_image' => true]);
		Settings::getInstance()->update('flags', ['app_header' => lang('helpdesk') . '::' . lang('email out')]);
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('helpdesk') . '::' . lang('email out') . '::' . lang('edit')]);
		...
		$data = array(
			...
			'form_action' => phpgw::link('/index.php', array('menuaction' => 'helpdesk.uiemail_out.save')),
			'cancel_url' => phpgw::link('/index.php', array('menuaction' => 'helpdesk.uiemail_out.index',)),
			'email_out' => $email_out,
			'mode' => $mode,
	...
	public function get_candidates()
	{
		...
		$set_id =  Sanitizer::get_var('set_id', 'int');
		$email_out_id =  Sanitizer::get_var('id', 'int');

		switch ($type)
		{
			case 'recipient_set':
				$values = $this->bo->get_recipient_candidates($set_id, $email_out_id);
				array_walk($values, array($this, "_add_links"), array(
					'menuaction' => 'helpdesk.uigeneric.edit',
