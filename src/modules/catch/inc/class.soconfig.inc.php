...
class catch_soconfig
{
	...
	var $db2;
	var $account;
	var $config_data, $join, $left_join, $like, $total_records, $serverSettings;
	...
	function add_type($values)
	{
		...
		$files_dir = isset($this->serverSettings['files_dir']) && $this->serverSettings['files_dir'] ? $this->serverSettings['files_dir'] : '';
