...
$preferenceHelper->create_input_box('Your Cellphone', 'cellphone', 'help text', '', 15);
$preferenceHelper->create_input_box('Your signature', 'signature', 'Signature to be appended to your sms-messages', '', 15);
