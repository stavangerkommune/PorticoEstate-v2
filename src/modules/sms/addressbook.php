...
//_debug_array($entries_comm);
	...
	$GLOBALS['phpgw']->template->set_var('cats_action', phpgw::link('/' . $GLOBALS['phpgw_info']['flags']['currentapp'] . '/addressbook.php', "sort=$sort&order=$order&filter=$filter&start=$start&query=$query"));
