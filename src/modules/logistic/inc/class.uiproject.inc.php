...
class logistic_uiproject extends phpgwapi_uicommon_jquery
{
	...
	public function __construct()
	{
		...
		self::set_active_menu("logistic::project");
	}
	...
	{
		Self::set_active_menu("admin::logistic::project_types");
		if (Sanitizer::get_var('phpgw_return_as') == 'json')
		{
			return $this->query();
		}
			...
			$data = array(
				...
				'datatable' => array(
					'source' => self::link(array(
						'menuaction' => 'logistic.uiproject.project_types',
	...
	public function view()
	{
		...
		if (isset($_POST['edit_project']))
		{
			phpgw::redirect_link('/index.php', array(
				'menuaction' => 'logistic.uiproject.edit',
				'id' => $project_id
			));
		}
		...
		else
		{
			...
			Settings::getInstance()->update('flags', ['app_header' => lang('logistic') . '::' . lang('Project')]);
	...
	public function edit_project_type()
	{
		...
		if (isset($_POST['save_project_type']))
		{
			...
			phpgw::redirect_link('/index.php', array(
				'menuaction' => 'logistic.uiproject.view_project_type',
				'id' => $project_type_id
			));
		}
		else if (isset($_POST['cancel_project_type']))
	...
	public function save()
	{
		...
		if ($project->validate())
		{
			...
			phpgw::redirect_link('/index.php', array(
				'menuaction' => 'logistic.uiproject.view',
				'id' => $project_id
			));
		}
		else
