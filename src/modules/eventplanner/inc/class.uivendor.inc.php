...
class eventplanner_uivendor extends phpgwapi_uicommon
{
	...
	{
		parent::__construct();
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('vendor')]);
...
*/
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('vendor') . '::' . lang('edit')]);
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uiapplication.query",
				'filter_vendor_id' => $id,
				'phpgw_return_as' => 'json'
			))),
		...
		self::add_javascript($this->currentapp, 'base', 'vendor.edit.js');
