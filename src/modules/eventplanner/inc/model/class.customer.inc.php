...
/*				'created' => array('action'=> ACL_READ,
				...
				'modified' => array('action'=>  ACL_EDIT,
					'type' => 'date',
					'label' => 'modified',
					'sortable' => true,
					),
				...
				'address_1' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => true
					),
				'address_2' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false),
				'zip_code' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => true),
				'city' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => true),
				'account_number' => array('action'=> ACL_ADD | ACL_EDIT,
			 	...
			 	'grant_non_public' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
