	...
	class eventplanner_application extends phpgwapi_model
	{
		...
		public static function get_fields($debug = true)
		{
			...
			$fields = array(
				...
				'display_in_dashboard' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'bool'),
				'category_id' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'label' => 'category',
					'history' => true),
				...
				'owner_id' => array('action'=> ACL_ADD,
			 	...
			 	'other_participants' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
			 	...
			 	'description' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'label' => 'application description',
					'sortable' => false,
					'required' => true,
					),
			 	'non_public' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
				...
				'vendor_id' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'label' => 'vendor',
					'sortable' => true,
					'history' => true,
				...
				'charge_per_unit' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
				...
				'timespan' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'label'	=> 'event timespan',
					'required' => true,
					'history' => true,
					),
				 'stage_width' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				 'stage_depth' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				 'stage_requirement' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				 'wardrobe' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				 'agreement_1' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => true,
					),
				 'agreement_2' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => true,
					),
				 'audience_limit' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				 'rig_up_min_before' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => true,
					),
				'rig_up_num_person' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'during_num_person' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'rig_down_num_person' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'rig_down_min_after' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => true,
					),
				'power' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'sound' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'light' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'piano' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'required' => false,
					),
				'power_remark' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				'sound_remark' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				'light_remark' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				'piano_remark' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				'equipment_remark' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					),
				'raider' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => false,
					)
			);
			...
			if($currentapp == 'eventplanner')
			{
				$backend_fields = array(
				 ...
				 'agreement_2' => array('action'=> 0,
					...
					'num_granted_events' => array('action'=> ACL_ADD | ACL_EDIT,
						'type' => 'int',
						'label' => 'number of granted events',
						'history' => true
					),
					'case_officer_id' => array('action'=> ACL_ADD | ACL_EDIT,
						'type' => 'int',
						'required' => true,
						'label' => 'case officer',
						'sortable' => true,
					...
					'case_officer_name' => array('action'=>  ACL_READ,
						'type' => 'string',
						'query' => true,
						'label' => 'case officer',
						'join' => array(
					...
					'status' => array('action'=> ACL_ADD | ACL_EDIT,
						'type' => 'int',
						'label' => 'status',
						'history' => true
						),
					'summary' => array('action'=> ACL_ADD | ACL_EDIT,
						'type' => 'html',
						'label' => 'summary',
						'sortable' => false,
					),
