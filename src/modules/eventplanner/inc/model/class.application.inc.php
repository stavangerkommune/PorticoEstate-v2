...
class eventplanner_application extends phpgwapi_model
{
	...
	public static function get_fields($debug = true)
	{
		...
		$fields = array(
			...
			'audience_limit' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => false,
			),
			'rig_up_min_before' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => true,
			),
			'rig_up_num_person' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => false,
			),
			'during_num_person' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => false,
			),
			'rig_down_num_person' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => false,
			),
			'rig_down_min_after' => array(
				'action' => ACL_ADD | ACL_EDIT,
				'type' => 'int',
				'required' => true,
			),
