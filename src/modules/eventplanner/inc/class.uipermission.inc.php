...
class eventplanner_uipermission extends phpgwapi_uicommon
{
	...
	{
		parent::__construct();
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('permission')]);
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('permission') . '::' . lang('edit')]);
	...
	{
		$users_frontend = (array)$this->acl->get_user_list_right(ACL_READ, 'run', 'eventplannerfrontend');
		$users_backend = (array)$this->acl->get_user_list_right(ACL_READ, 'run', 'eventplanner');
