...
class eventplanner_boevents extends phpgwapi_bocommon
{
	...
	public function read($params)
	{
		...
		foreach ($values['results'] as &$entry)
		{
			...
			$entry['date_start'] = $this->phpgwapi_common->show_date($dates['date_start'], $dateformat);
			$entry['date_end'] = $this->phpgwapi_common->show_date($dates['date_end'], $dateformat);
			$entry['case_officer_id'] = $entry['case_officer_id'] ? $accounts_obj->get($entry['case_officer_id'])->__toString() : '';
		}
		return $values;
	}
