...
class eventplanner_uibooking extends phpgwapi_uicommon
{
	...
	{
		parent::__construct();
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('booking')]);
...
*/
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('booking') . '::' . lang('edit')]);
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uivendor_report.query",
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uicustomer_report.query",
				'filter_booking_id' => $id ? $id : -1,
				'phpgw_return_as' => 'json'
			))),
		...
		self::add_javascript($this->currentapp, 'base', 'booking.edit.js');
		phpgwapi_jquery::load_widget('autocomplete');
