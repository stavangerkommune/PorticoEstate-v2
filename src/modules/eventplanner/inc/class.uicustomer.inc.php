...
class eventplanner_uicustomer extends phpgwapi_uicommon
{
	...
	{
		parent::__construct();
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('customer')]);
...
*/
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('eventplanner') . '::' . lang('customer') . '::' . lang('edit')]);
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uibooking.query_relaxed",
