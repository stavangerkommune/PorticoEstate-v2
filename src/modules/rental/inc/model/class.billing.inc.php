...
class rental_billing extends rental_model
{
	...
	public function serialize()
	{
		...
		$account = $accounts_obj->get($this->get_created_by());
		$timestamp_commit = '';
		if ($this->get_timestamp_commit() != null && $this->get_timestamp_commit())
		{
			$timestamp_commit = $phpgwapi_common->show_date($this->get_timestamp_commit(), $date_format . ' H:i:s');
		...
		return array(
			...
			'timestamp_stop' => $phpgwapi_common->show_date($this->get_timestamp_stop(), $date_format . ' H:i:s'),
