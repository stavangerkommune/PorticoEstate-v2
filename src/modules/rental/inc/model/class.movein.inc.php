...
class rental_movein extends phpgwapi_model
{
	...
	public static function get_custom_fields()
	{
		...
		if (!$custom_fields)
		{
			$custom_fields = createObject('phpgwapi.custom_fields')->find('rental', self::acl_location, 0, '', 'ASC', 'attrib_sort', true, true);
		}
	...
	protected function preValidate(&$entity)
	{
		...
		if (!$entity->get_id())
		{
			$entity->account_id = (int)$this->userSettings['account_id'];
		}
	}
