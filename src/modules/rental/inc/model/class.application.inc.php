	...
	class rental_application extends phpgwapi_model
	{
		...
		public static function get_fields($debug = true)
		{
			 $fields = array(
				...
				'district_id' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int'),
				'composite_type_id' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int'),
				'date_start' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'date'),
				'date_end' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'date'),
				'cleaning' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'bool'),
				'payment_method' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'int'),
				'firstname' => array(
					'action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
				...
				'lastname' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
					'required' => true,
					'query' => true,
					'alternative' => array('company_name'),
				...
				'job_title' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'company_name' => array(
					'action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
				...
				'department' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'address1' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'address2' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'postal_code' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'place' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'account_number' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'phone' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'email' => array(
				...
				'unit_leader' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
				'comments' => array(
					'action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string',
				...
				'assign_date_start' => array('action'=> ACL_READ | ACL_EDIT,
					'type' => 'date',
					'label'=> 'assign_start',
					'history' => true
					),
				'assign_date_end' => array('action'=> ACL_READ | ACL_EDIT,
					'type' => 'date',
					'label'=> 'assign_end',
					'history' => true
					),
				'status' => array('action'=> ACL_READ | ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'history' => true,
					),
				'entry_date' => array('action'=> ACL_READ | ACL_ADD,
					'type' => 'int',
					'label' => 'entry_date',
					'sortable' => true,
					),
				'executive_officer' => array('action'=> ACL_READ | ACL_ADD | ACL_EDIT,
					'type' => 'int',
					'label' => 'executive_officer',
					'sortable' => true,
					'history' => true,
					),
				'identifier' => array('action'=> ACL_ADD | ACL_EDIT,
					'type' => 'string'),
			);
