...
abstract class rental_uicommon extends phpgwapi_uicommon_jquery
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang($this->flags['currentapp'])]);

		$config = CreateObject('phpgwapi.config', 'rental');
		$config->read();

		$this->thousandsSeparator = ($this->userSettings['preferences']['rental']['thousands_separator']) ? $this->userSettings['preferences']['rental']['thousands_separator'] : ' ';
		$this->decimalSeparator = ($this->userSettings['preferences']['rental']['decimal_separator']) ? $this->userSettings['preferences']['rental']['decimal_separator'] : ',';
		$this->decimalPlaces = ($this->userSettings['preferences']['rental']['currency_decimal_places']) ? $this->userSettings['preferences']['rental']['currency_decimal_places'] : 2;
