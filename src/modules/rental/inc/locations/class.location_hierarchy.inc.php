...
class location_hierarchy
{
	...
	public static function get_hierarchy()
	{
		...
		$city_counsil_dep = $location_obj->get_subs_from_pattern('rental', city_counsil_dep::$pattern);
		...
		$result_units = $location_obj->get_subs_from_pattern('rental', result_unit::$pattern);
	...
	public static function get_name_of_location(int $location_id)
	{
		...
		$location_name = $location_obj->get_name($location_id);
