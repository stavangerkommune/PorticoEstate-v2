...
class rental_uifrontpage extends rental_uicommon
{
	...
	private function _get_tableDef_working()
	{
		$columns_def = array(
			...
			array(
				'key' => 'last_edited_by_current_user',
				'label' => lang('last_edited_by_current_user'),
				'sortable' => false
			),
...
*/
	...
	public function index()
	{
		...
		$tabs['executive_officer'] = array(
			'label' => lang('executive_officer'),
			'link' => '#executive_officer',
			'function' => 'getData_executive_officer()'
		);
		$tabs['contracts_under_dismissal'] = array(
			'label' => lang('contracts_under_dismissal'),
			'link' => '#contracts_under_dismissal',
			'function' => 'getData_contracts_under_dismissal()'
		);
		$tabs['contracts_closing_due_date'] = array(
			'label' => lang('contracts_closing_due_date'),
			'link' => '#contracts_closing_due_date',
			'function' => 'getData_contracts_closing_due_date()'
		);
		$tabs['terminated_contracts'] = array(
			'label' => lang('terminated_contracts'),
			'link' => '#terminated_contracts',
			'function' => 'getData_terminated_contracts()'
		);
		...
		$datatable_def = array_merge(
			...
			$tableDef_contracts_closing_due_date,
			$tableDef_terminated_contracts,
			$tableDef_notifications
		);

		$params_executive_officer = json_encode(array(
			'menuaction' => 'rental.uicontract.query',
			'type' => 'contracts_for_executive_officer',
			'editable' => false,
			'phpgw_return_as' => 'json'
		));
		$params_contracts_under_dismissal = json_encode(array(
			'menuaction' => 'rental.uicontract.query',
			'type' => 'ending_contracts',
			'editable' => false,
			'phpgw_return_as' => 'json'
		));
		$params_contracts_closing_due_date = json_encode(array(
			'menuaction' => 'rental.uicontract.query',
			'type' => 'closing_due_date',
			'editable' => false,
			'phpgw_return_as' => 'json'
		));
		$params_terminated_contracts = json_encode(array(
			'menuaction' => 'rental.uicontract.query',
			'type' => 'terminated_contracts',
			'editable' => false,
			'phpgw_return_as' => 'json'
		));
		$params_notifications = json_encode(array(
			'menuaction' => 'rental.uinotification.query',
			'type' => 'notifications_for_user',
			'editable' => false,
			'phpgw_return_as' => 'json'
		));
