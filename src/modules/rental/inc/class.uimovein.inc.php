...
class rental_uimovein extends phpgwapi_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('movein')]);
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('movein') . '::' . lang('edit')]);
		...
		$contract_id = $movein->contract_id ? $movein->contract_id : Sanitizer::get_var('contract_id', 'int');
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => 'rental.uimovein._get_files',
				'id' => $id,
				'phpgw_return_as' => 'json'
			))),
			'ColumnDefs' => $file_def,
		...
		$data = array(
			...
			'form_action' => phpgw::link('/index.php', array('menuaction' => 'rental.uimovein.save')),
			'cancel_url' => phpgw::link('/index.php', array('menuaction' => 'rental.uimovein.index',)),
			'movein' => $movein,
