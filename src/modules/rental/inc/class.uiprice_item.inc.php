...
class rental_uiprice_item extends rental_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('price_list')]);
	}


	private function get_types_options($selected = 0)
	{
		$types = rental_socontract::get_instance()->get_fields_of_responsibility();
		$types_options = array(array('id' => '', 'name' => lang('Select')));
	...
	public function index()
	{
		...
		$types_options = $this->get_types_options();
		...
		$data = array(
			...
			'datatable' => array(
				...
				'allrows' => true,
				'new_item'		 => self::link(array('menuaction' => 'rental.uiprice_item.add')),
				'editor_action' => '',
				'field' => array(
					array(
						'key' => 'agresso_id',
...
JS;
	...
	{
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('price_list') . '::' . lang('view')]);
	...
	{
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('price_list') . '::' . lang('edit')]);
		...
		$responsibility_title = $price_item->get_responsibility_title();
		...
		$data = array(
			...
			'responsibility_list'			 => array('options' => $this->get_types_options($price_item->get_responsibility_id())),
			'mode'							 => $mode,
	...
	public function set_value()
	{
		...
		switch ($field_name)
		{
			case 'count':
				...
				break;
			case 'price':
				$value = (float)trim(str_replace(array($this->currency_suffix, " ", ','), array('', '', '.'), $value));
				break;
			case 'date_start':
			case 'date_end':
	...
	{
		Settings::getInstance()->update('flags', ['app_header' => lang('rental') . '::' . lang('price_list') . '::' . lang('manual_adjustment')]);
		if (!$this->isExecutiveOfficer())
		{
			phpgw::no_access();
		}
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => 'rental.uiadjustment.query',
