<?php
	...
	class rental_menu
	{
		...
		function get_menu()
		{
			...
			if (
				$GLOBALS['phpgw']->acl->check(rental_uicommon::LOCATION_IN, ACL_ADD, 'rental') ||
				$GLOBALS['phpgw']->acl->check(rental_uicommon::LOCATION_OUT, ACL_ADD, 'rental') ||
				$GLOBALS['phpgw']->acl->check(rental_uicommon::LOCATION_INTERNAL, ACL_ADD, 'rental')
			)
			{
				$billing = array(
					'invoice' => array
						...
						'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uibilling.index',
							'appname' => 'rental')),
					...
					'price_item_list' => array
						...
						'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiprice_item.index',
							'appname' => 'rental')),
						...
						'children' => array(
							'manual_adjustment' => array
								...
								'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiprice_item.manual_adjustment',
									'appname' => 'rental')),
								'image' => array('rental', 'x-office-spreadsheet')
							)
						)
					...
					'adjustment' => array
						...
						'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiadjustment.index',
							'appname' => 'rental')),
						'image' => array('rental', 'x-office-spreadsheet')
					)
				);
				...
				$sync_choices = array(
					'sync_org_unit' => array
						...
						'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiparty.sync',
				...
				$sub_parties = array(
					...
					'resultunit' => array
						(
						'text' => lang('delegates'),
						'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiresultunit.index',
							'appname' => 'rental')),
				...
				$menus['navigation']['email_out'] = array(
					...
					'children' => array(
						'email_template' => array(
							...
							'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uigeneric.index',
			...
			$menus['admin'] = array
				...
				'import' => array
					...
					'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiimport.index',
						'appname' => 'rental')),
				...
				'import_adjustments' => array
					...
					'url' => phpgw::link('/index.php', array('menuaction' => 'rental.uiimport.import_regulations',
						'appname' => 'rental')),
					'image' => array('rental', 'document-save')
				),
			...
			$menus['preferences'] = array
				...
				array
					...
					'url' => phpgw::link('/preferences/preferences.php', array('appname' => 'rental',
						'type' => 'user'))
				),
				array
					(
