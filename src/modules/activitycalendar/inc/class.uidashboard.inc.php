...
class activitycalendar_uidashboard extends activitycalendar_uicommon
{
	...
	public function index()
	{
		...
		$jqcal->add_listener('date_change');

		$columns_def_organization = array(
			array(
				'key' => 'organization_number',
				'label' => lang('organization_number'),
				'sortable' => false
			),
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => 'activitycalendar.uiorganization.query',
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => 'activitycalendar.uiactivities.query',
				'type' => 'new_activities',
				'phpgw_return_as' => 'json'
			))),
			'data' => json_encode(array()),
		...
		foreach ($districts as $district)
		{
			...
			$activity_district_options[] = array(
				'id' => $district['id'],
				'name' => $district['name'],
				'selected' => $selected
			);
		...
		{
			$activity_category_options[] = array(
				'id' => $category->get_id(),
	...
	public function add_actions(&$value, $key, $params)
	{
		...
		switch ($query_type)
		{
			...
			case 'changed_organizations':
				...
				{
					$value['actions'][] = html_entity_decode(self::link(array(
						'menuaction' => 'activitycalendar.uiorganization.show',
						'id' => $value['id'],
						'type' => 'group'
					)));
				}
				...
				if ($value['transferred'] == false)
				{
					...
					{
						$value['actions'][] = html_entity_decode(self::link(array(
							'menuaction' => 'activitycalendar.uiorganization.edit',
							'id' => $value['id']
						)));
					}
