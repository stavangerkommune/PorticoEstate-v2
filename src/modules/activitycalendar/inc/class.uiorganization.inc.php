...
class activitycalendar_uiorganization extends activitycalendar_uicommon
{
		...
		$data = array(
			...
			'datatable' => array(
				...
				'download' => self::link(array(
					'menuaction' => 'activitycalendar.uiorganization.download',
					'type' => $type,
					'export' => true,
					'allrows' => true
				)),
	...
	public function save()
	{
		...
		$so_activity = activitycalendar_soactivity::get_instance();
		//$so_contact	 = activitycalendar_socontactperson::get_instance();
		$org_array = $so_org->get(0, 0, '', false, '', '', array(
			'id' => $id,
			'changed_orgs' => 'true'
		));
	...
	{
		Settings::getInstance()->update('flags', ['app_header' => lang('activitycalendar') . '::' . lang('organization') . '::' . lang('edit')]);
	...
	{
		Settings::getInstance()->update('flags', ['app_header' => lang('activitycalendar') . '::' . lang('organization') . '::' . lang('view')]);
