		...
		switch ($type)
		{
			...
			case 'control':
				$info = array(
					...
					'edit_msg'			 => lang('edit'),
					'add_msg'			 => lang('add'),
					'name'				 => $this->translation->translate('office', array(), false, 'booking'),
					'acl_app'			 => 'controller',
					'acl_location'		 => 'admin',
			...
			case 'control_category':
				$info = array(
					...
					'fields'			 => array(
						array(
							'name'		 => 'control_id',
							'descr'		 => $this->translation->translate('control', array(), false, 'controller'),
							'type'		 => 'select',
							'filter'	 => true,
							'values_def' => array(
								'valueset'			 => false,
					...
					'edit_msg'			 => lang('edit'),
					'add_msg'			 => lang('add'),
					'name'				 => $this->translation->translate('category', array(), false, 'controller'),
					'acl_app'			 => 'controller',
					'acl_location'		 => 'admin',
					'system_location'	 => 'admin',
