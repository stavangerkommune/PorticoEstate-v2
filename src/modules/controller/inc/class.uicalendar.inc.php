...
class controller_uicalendar extends phpgwapi_uicommon_jquery
{
	...
	public function __construct()
	{
		...
		$read = $this->acl->check('.control', ACL_READ, 'controller'); //1
		$add = $this->acl->check('.control', ACL_ADD, 'controller'); //2
		$edit = $this->acl->check('.control', ACL_EDIT, 'controller'); //4
		$delete = $this->acl->check('.control', ACL_DELETE, 'controller'); //8
	...
	public function view_calendar_for_month()
	{
		...
		if ($location_code != null && $location_code != "")
		{
			...
			$property_array = execMethod('property.solocation.read', array(
				'type_id' => 1,
				'allrows' => true
			));
			...
			self::render_template_xsl(array(
				'calendar/view_calendar_month', 'calendar/check_list_status_manager',
	...
	public function view_calendar_for_year()
	{
		...
		if ($location_code != null && $location_code != "")
		{
			...
			self::render_template_xsl(array(
				'calendar/view_calendar_year', 'calendar/check_list_status_manager',
				'calendar/icon_color_map', 'calendar/select_my_locations',
	...
	public function view_calendar_for_year2($location_array = null, $year = null)
	{
		...
		if (is_array($location_array))
		{
			...
			self::render_template_xsl(array(
				'calendar/view_calendar_aggregated', 'calendar/check_list_status_manager',
	...
	public function view_calendar_year_for_locations()
	{
		...
		self::render_template_xsl(array(
			'calendar/view_calendar_year_for_locations', 'calendar/check_list_status_manager',
			'calendar/icon_color_map', 'calendar/select_my_locations', 'calendar/nav_calendar_year'
		), $data);
	...
	public function view_calendar_month_for_locations()
	{
		...
		self::render_template_xsl(array(
			'calendar/view_calendar_month_for_locations',
			'calendar/check_list_status_manager',
			'calendar/icon_color_map', 'calendar/select_my_locations', 'calendar/nav_calendar_month'
		), $data);
