...
class controller_uisettings extends phpgwapi_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('controller') . '::' . lang('settings')]);
	...
	public function users($error = false)
	{
		...
		$dateformat = "{$this->userSettings['preferences']['common']['dateformat']} H:i";
		...
		foreach ($users as $user)
		{
			...
			$user_list[] = array(
				...
				'lastlogin' => $this->phpgwapi_common->show_date($user['account_lastlogin'], $dateformat),
