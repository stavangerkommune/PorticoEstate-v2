...
class controller_uicheck_list_for_component extends phpgwapi_uicommon_jquery
{
	...
	function add_component_to_control()
	{
		...
		else
		{
			...
			$data = array(
				'tabs' => $this->phpgwapi_common->create_tabs($tabs, 1),
				...
				'datatable' => array(
					'source' => self::link(array(
						'menuaction' => 'controller.uicheck_list_for_component.add_component_to_control',
						'phpgw_return_as' => 'json'
					)),
					'field' => array(
						array(
