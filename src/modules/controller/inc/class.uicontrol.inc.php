...
class controller_uicontrol extends phpgwapi_uicommon_jquery
{
	...
	public function control_list()
	{
		...
		$control_areas = $cats->formatted_xslt_list(array(
			'format' => 'filter', 'selected' => $control_area_id,
		...
		$data = array(
			...
			'datatable' => array(
				'source' => self::link(array(
					'menuaction' => 'controller.uicontrol.control_list',
	...
	public function view_control_details($control = null)
	{
		if ($control == null)
		{
			$control_id = Sanitizer::get_var('id');
		...
		$ticket_cat_list = $catsObj->formatted_xslt_list(array(
	...
	public function save_control_details()
	{
		...
		{
			phpgw::redirect_link('/index.php', array('menuaction' => 'controller.uicontrol.index'));
		}
	...
	public function save_control_groups()
	{
		...
		$control_id = Sanitizer::get_var('control_id');
		$control_group_ids = Sanitizer::get_var('control_group_ids');
	...
	public function save_control_items()
	{
		...
		self::redirect(array(
			'menuaction' => 'controller.uicontrol.view_check_list',
			'control_id' => $control_id
		));
	}
	...
	public function add_actions(&$value, $key, $params)
	{
		...
		$value['ajax'][] = false;
		$value['actions'][] = html_entity_decode(self::link(array(
			'menuaction' => 'controller.uicontrol.view_locations_for_control',
			'id' => $value['control_id']
		)));
	...
	public function query()
	{
		...
		$responsibility = Sanitizer::get_var('responsibilities');
		if (isset($responsibility) && $responsibility > 0)
		{
			$filters['responsibilities'] = $responsibility;
		}

		$filters['district_id'] = Sanitizer::get_var('district_id', 'int', 'REQUEST', null);
