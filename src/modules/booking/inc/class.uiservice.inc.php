...
class booking_uiservice extends phpgwapi_uicommon
{
	...
	{
		parent::__construct();
		Settings::getInstance()->update('flags', ['app_header' => lang('booking') . '::' . lang('Service')]);
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('booking') . '::' . lang('Service') . '::' . lang('edit')]);
