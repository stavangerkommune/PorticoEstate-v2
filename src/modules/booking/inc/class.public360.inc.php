...
class booking_public360
{
	...
	private $debug, $webservicehost, $authkey, $proxy, $archive_user_id, $userSettings;
	...
	public function __construct()
	{
		...
		$this->archive_user_id	 = $this->userSettings['preferences']['common']['archive_user_id'];
	}
	...
	private function log($what, $value = '')
	{
		...
		if (!empty($serverSettings['log_levels']['module']['booking']))
		{
			$log = new Log();
			$log->debug(array(
