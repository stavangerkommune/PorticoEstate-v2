...
class booking_uibuilding extends booking_uicommon
{
		...
		$data = array(
			...
			'datatable'		 => array(
				'source' => self::link(array(
					'menuaction'		 => $this->module . '.uibuilding.index',
	...
	public function query()
	{
		...
		{
			$building['link'] = $this->link(array(
				'menuaction' => $this->module . '.uibuilding.show',
				'id'		 => $building['id']
			));
	...
	public function show()
	{
		...
		$building['message_link']		 = self::link(array(
			'menuaction'	 => 'booking.uisystem_message.edit',
		...
		$building['location_link']		 = self::link(array(
	...
	public function schedule()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('booking') . "::{$building['name']}"]);
