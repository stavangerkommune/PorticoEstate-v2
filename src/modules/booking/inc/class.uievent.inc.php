...
class booking_uievent extends booking_uicommon
{
	...
	public function __construct()
	{
		...
		$this->fields = array(
			'activity_id', 'name', 'organizer', 'homepage', 'description', 'equipment',
	...
	public function add()
	{
		...
		$jqcal2->add_listener('start_date', 'datetime', phpgwapi_datetime::user_localtime(), array('min_date' => phpgwapi_datetime::user_localtime()));
		$jqcal2->add_listener('end_date', 'datetime', phpgwapi_datetime::user_localtime(), array('min_date' => phpgwapi_datetime::user_localtime()));
	...
	public function edit()
	{
		...
		$external_site_address = isset($config['external_site_address']) && $config['external_site_address'] ? $config['external_site_address'] : $this->serverSettings['webserver_url'];
...
*/
		...
		$jqcal2 = createObject('phpgwapi.jqcal2');
		$jqcal2->add_listener('from_', 'datetime', phpgwapi_datetime::date_to_timestamp($event['from_']));
		$jqcal2->add_listener('to_', 'datetime', phpgwapi_datetime::date_to_timestamp($event['to_']));
		...
		$event['resources_json'] = json_encode(array_map('intval', $event['resources']));
		$event['application_link'] = self::link(array(
		...
		$internal_site_address = $this->serverSettings['webserver_url'];
	...
	public function delete()
	{
		...
		if ($this->acl->check('admin', Acl::ADD, 'booking'))
		{
	...
	public function info()
	{
		...
		$event['edit_link'] = self::link(array(
