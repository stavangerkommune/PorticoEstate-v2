...
class booking_filestorage
{
	...
	public function __construct($owner)
	{
		...
		$server_files_dir = $this->_chomp_dir_sep($serverSettings['files_dir']);
	...
	{
		if (
			is_dir($this->get_files_path()) && is_writable($this->get_files_path()) && is_readable($this->get_files_path())
		)
		{
			return true;
		}
