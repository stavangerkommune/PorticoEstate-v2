	...
	public function index()
	{
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST')
		{
			...
			if (isset($_POST['billing']))
			{
				...
				$db->query("UPDATE bb_billing_sequential_number_generator SET value=" . $internal_value . " WHERE name='internal'");
				$db->query("UPDATE bb_billing_sequential_number_generator SET value=" . $external_value . " WHERE name='external'");
			}
		}
		...
		self::render_template_xsl('settings', array(
