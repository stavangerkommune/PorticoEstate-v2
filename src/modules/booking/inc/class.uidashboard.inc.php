...
class booking_uidashboard extends booking_uicommon
{
	...
	public function index()
	{
		...
		Settings::getInstance()->update('flags', ['manual' => ['section' => 'booking_manual']]);
	...
	public function query()
	{
		...
		foreach ($applications['results'] as &$application)
		{
			...
			$account_id = $accounts_obj->name2id($application['case_officer_name']);
			if ($account_id)
			{
				$application['case_officer_name'] = $accounts_obj->get($account_id)->__toString();
			}
		}
