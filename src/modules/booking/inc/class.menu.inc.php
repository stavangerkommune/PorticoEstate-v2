		...
		function get_menu()
		{
			...
			if (isset($userSettings['apps']['admin']))
			{
				$menus['navigation']['settings'] = array
					(
					'text' => lang('Settings'),
					'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uipermission_root.index',
						'appname' => 'booking')),
					...
					(
						...
						'rescategory' => array
							...
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uirescategory.index',
								'appname' => 'booking'))
						),
						'activity' => array
							(
							'text' => lang('Activity'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiactivity.index',
								'appname' => 'booking'))
						),
						'facility' => array
							(
							'text' => lang('Facilities'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uifacility.index',
								'appname' => 'booking'))
						),
						...
						'audience' => array
							(
							'text' => lang('Audience'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiaudience.index',
								'appname' => 'booking'))
						),
						'agegroup' => array
							(
							'text' => lang('Age group'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiagegroup.index',
								'appname' => 'booking'))
						),
						'account_code_sets' => array
							(
							'text' => lang('Account Codes'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiaccount_code_set.index',
								'appname' => 'booking'))
						),
						'account_code_dimensions' => array
							(
							'text' => lang('Account Code Dimension'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiaccount_code_dimension.index',
								'appname' => 'booking'))
						),
						'async_settings' => array
							(
							'text' => lang('Asynchronous Tasks'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiasync_settings.index',
								'appname' => 'booking'))
						),
						'documentation' => array
							(
							'text' => lang('Documentation'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uidocumentation.index',
								'appname' => 'booking'))
						),
						'mail_settings' => array
							(
							'text' => lang('Mail Settings'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uimail_settings.index',
								'appname' => 'booking'))
						),
						'event_mail_settings' => array
							(
							'text' => lang('Event Mail Settings'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uievent_mail_settings.index',
								'appname' => 'booking'))
						),
						'application_settings' => array
							(
							'text' => lang('Application Settings'),
							'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uiapplication_settings.index',
								'appname' => 'booking'))
						),
						'e_lock_system' => array(
			...
			if ($acl->check('run', Acl::READ, 'admin') || $acl->check('admin', Acl::ADD, 'booking'))
			{
				$menus['admin'] = array
					...
					(
						...
						'nav_location'	 => 'navbar#' . $locations->get_id('booking', 'run'),
						'url'			 => phpgw::link('/index.php', array('menuaction'	 => 'admin.uiconfig2.index',
							'location_id'	 => $locations->get_id('booking', 'run')))
					),
					'permissions' => array
						(
						'text' => lang('Root Permissions'),
					...
					'settings' => array
						(
						'text' => lang('Settings'),
						'url' => phpgw::link('/index.php', array('menuaction' => 'booking.uisettings.index',
							'appname' => 'booking'))
					),
				);
			}
