...
JS;
	...
	protected function add_default_display_data(&$reservation)
	{
		...
		{
			$reservation['season_link'] = $this->link_to('show', array(
				'ui' => 'season',
		...
		{
			$reservation['organization_link'] = $this->link_to('show', array(
				'ui' => 'organization',
		...
		if (!empty($reservation['exported']))
		{
			$reservation['exported_link'] = $this->link_to('show', array(
				'ui' => 'completed_reservation_export',
				'id' => $reservation['exported']
			));
		}
	...
	public function edit()
	{
		...
		$tabs = array();
		$tabs['completed_reservation_edit'] = array(
			'label' => lang('Reservation edit'),
