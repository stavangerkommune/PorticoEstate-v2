...
class booking_uidocumentation extends booking_uicommon
{
	...
	public function __construct()
	{
		...
		Settings::getInstance()->update('flags', ['app_header' => lang('booking') . "::" . lang('Documentation')]);
	}
	...
	public function query()
	{
		...
		{
			$document['link'] = self::link(array(
				'menuaction' => $this->module . '.uidocumentation.download',
				'id' => $document['id']
			));
			...
			$document['option_edit'] = self::link(array(
				'menuaction' => $this->module . '.uidocumentation.edit',
				'id' => $document['id']
			));
			$document['option_delete'] = self::link(array(
				'menuaction' => $this->module . '.uidocumentation.delete',
				'id' => $document['id']
			));
		}
