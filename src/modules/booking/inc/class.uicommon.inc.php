...
abstract class booking_uicommon extends phpgwapi_uicommon_jquery
{
	...
	protected static function get_file_type_from_extension($file, $defaultType = 'application/octet-stream')
	{
		...
		switch ($extension)
		{
			...
			case 'cpt':
				return 'application/x-mac-compactpro';
			case 'mbd':
				return 'application/mbed';
			case 'mfp':
			...
			case 'ami':
				return 'application/vnd.amiga.amu';
			case 'mpm':
			...
			case 'fsc':
				return 'application/vnd.fsc.weblauch';
			case 'txd':
			...
			case 'htke':
				return 'application/vnd.kenameapp';
			case 'kia':
			...
			case 'vtk':
				return 'application/vocaltec-talker';
			case 'wif':
				return 'image/cewavelet';
			case 'wp5':
				return 'application/wordperfect5.1';
			case 'wk':
				return 'application/x-123';
			case '7ls':
				return 'application/x-7th_level_event';
			case 'aab':
			...
			case 'hep':
				return 'application/x-hep';
			case 'rhtml':
				return 'application/x-html+ruby';
			case 'mv':
				return 'application/x-httpd-miva';
			case 'phtml':
				return 'application/x-httpd-php';
			case 'ica':
				return 'application/x-ica';
			case 'imagemap':
				return 'application/x-imagemap';
			case 'ipx':
			...
			case 'rp':
				return 'application/x-pn-realmedia';
			case 'py':
			...
			case 'vqf':
				return 'application/x-twinvq';
			case 'vqe':
				return 'application/x-twinvq-plugin';
			case 'ustar':
				return 'application/x-ustar';
			case 'bck':
				return 'application/x-vmsbackup';
			case 'src':
				return 'application/x-wais-source';
			case 'wz':
				return 'application/x-wingz';
			case 'wp6':
				return 'application/x-wordperfect6.1';
			case 'crt':
			...
			case 'pdb':
				return 'x-chemical/x-pdb';
			case 'scr':
				return 'chemical/x-rasmol';
			case 'xyz':
				return 'x-chemical/x-xyz';
			case 'dwf':
				return 'x-drawing/dwf';
			case 'ivr':
			...
			case 'svf':
				return 'image/vn-svf';
			case 'dgn':
				return 'image/vnd.dgn';
			case 'djvu':
				return 'image/vnd.djvu';
			case 'dwg':
				return 'image/vnd.dwg';
			case 'pgb':
				return 'image/vnd.glocalgraphics.pgb';
			case 'ico':
...
JS;
	...
	public function adddatetimepicker($type = 'datetime')
	{
		...
		$dateformat = str_ireplace(array('y'), array('Y'), $this->userSettings['preferences']['common']['dateformat']);
		...
		$userlang = 'en';
		if (isset($this->userSettings['preferences']['common']['lang']))
		{
