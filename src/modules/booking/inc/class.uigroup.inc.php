...
class booking_uigroup extends booking_uicommon
{
		...
		$data = array(
			...
			'datatable' => array(
				'source' => self::link(array(
					'menuaction' => $this->module . '.uigroup.index',
	...
	public function edit()
	{
		...
		if ($id)
		{
			...
			$group['id'] = $id;
			$group['organization_link'] = $this->link_to('show', array(
				'ui' => 'organization',
		...
		else
		{
			...
			if ($organization_id)
			{
				$group['cancel_link'] = self::link(array(
	...
	public function show()
	{
		...
		$group['organization_link'] = self::link(array(
			'menuaction' => $this->module . '.uiorganization.show',
			'id' => $group['organization_id']
		));
		$group['edit_link'] = self::link(array(
		...
		self::render_template_xsl('group', array(
			'group' => $group, 'loggedin' => $loggedin,
