...
class addressbook_uicatalog_contact_comm_type extends phpgwapi_uicommon
{
	...
	function view()
	{
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uicatalog_contact_comm_type.view",
				'phpgw_return_as' => 'json'
			))),
	...
	{
		$values['id'] = Sanitizer::get_var('id');
		$values['description'] = array('comm_type_description' => Sanitizer::get_var('comm_type_description'));
