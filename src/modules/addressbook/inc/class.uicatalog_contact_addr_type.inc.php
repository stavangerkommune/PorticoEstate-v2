		...
		function view()
		{
			...
			$tabletools[] = array
				...
				'custom_code' => "
					...
					var parameters = " . json_encode(array('parameter' => array(array('name' => 'addr_type_id',
							'source' => 'addr_type_id')))) . ";
			...
			$datatable_def[] = array
				...
				'requestUrl' => json_encode(self::link(array('menuaction' => "{$this->currentapp}.uicatalog_contact_addr_type.view", 
						'phpgw_return_as' => 'json'))),
