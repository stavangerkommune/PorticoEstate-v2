...
class addressbook_uicatalog_contact_note_type extends phpgwapi_uicommon
{
	...
	function view()
	{
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction' => "{$this->currentapp}.uicatalog_contact_note_type.view",
				'phpgw_return_as' => 'json'
			))),
	...
	{
		$values['id'] = Sanitizer::get_var('note_type_id');
		$values['description'] = array('note_description' => Sanitizer::get_var('note_description'));
	...
	function delete()
	{
		$ids = Sanitizer::get_var('note_type_id');
