...
class registration_uimanagefields
{
	...
	function admin($message = NULL)
	{
		...
		$row_color	 = $nextmatches->alternate_row_color($row_color);
		$var		 = array(
			'row_off' => $nextmatches->alternate_row_color($row_color)
		);
		$p->set_var($var);

		$row_color	 = $nextmatches->alternate_row_color($row_color);
		$var		 = array(
			'row_on' => $nextmatches->alternate_row_color($row_color)
		);
		$p->set_var($var);
	...
	function submit()
	{
		...
		phpgw::redirect_link($this->base_url, array(
			'menuaction' => 'registration.uimanagefields.admin',
			'message'	 => 'Updated'
		));
	}
}
