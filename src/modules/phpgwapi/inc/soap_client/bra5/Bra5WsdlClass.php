...
class Bra5WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
     ...
     * If a class is named as {Bra5}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('Bra5SoapClient') && is_subclass_of('Bra5SoapClient','SoapClient'))
