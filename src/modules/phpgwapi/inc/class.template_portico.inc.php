<?php
	...
	class phpgwapi_template_portico
	{
		...
		public function store()
		{
			...
			$data = Sanitizer::get_var('data', 'raw');
			...
			Cache::session_set('phpgwapi', "template_portico_$location", $json);
			return $json;
		}
		...
		{
			return (array) Cache::session_get('phpgwapi', "template_portico_$location");
		}
		...
		{
			Cache::session_set('phpgwapi', "template_portico_$location", $data);
		}
	}
