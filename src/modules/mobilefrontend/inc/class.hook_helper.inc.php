...
class mobilefrontend_hook_helper
{
	...
	public function set_auth_type()
	{
		...
		{
			Settings::getInstance()->update('server', ['auth_type' => $this->config['auth_type']]);
		}
	}
	...
	public function set_cookie_domain()
	{
		...
		{
			Settings::getInstance()->update('server', ['cookie_domain' => $this->config['cookie_domain']]);
		}
		Settings::getInstance()->update('server', ['usecookies' => $this->config['usecookies']]);
	}
}
