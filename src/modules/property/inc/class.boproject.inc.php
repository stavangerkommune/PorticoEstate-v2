...
class property_boproject
{
	...
	function column_list($selected = array())
	{
		if (!$selected)
		{
			...
			$selected = isset($userSettings['preferences']['property']['project_columns']) ? $userSettings['preferences']['property']['project_columns'] : '';
		}
	...
	private function get_vendor_name($vendor_id = 0)
	{
		...
		else
		{
			...
			$vendor = $contacts->read_single(array('id' => $vendor_id), array(
				'id'		 => $vendor_id,
