...
class property_uireport extends phpgwapi_uicommon_jquery
{
	...
	public function __construct()
	{
		...
		self::set_active_menu('property::report');
	...
	public function index()
	{
		...
		$related_def = array(
			array(
				'key'		 => 'id', 'label'		 => lang('ID'), 'sortable'	 => true, 'resizeable' => true,
				'hidden'	 => true
			),
			array('key' => 'report_name', 'label' => lang('name'), 'sortable' => true, 'resizeable' => true),
			array(
				'key'		 => 'dataset_name', 'label'		 => lang('dataset'), 'sortable'	 => true,
				'resizeable' => true
			)
		);
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction'		 => 'property.uireport.index',
		...
		$related_def_views = array(
			...
			array(
				'key'		 => 'n_reports', 'label'		 => lang('number of reports'), 'sortable'	 => true,
				'resizeable' => true
			)
		);
	...
	public function edit($values = array(), $mode = 'edit')
	{
		...
		$this->flags['app_header'] = lang('property') . ' - ' . lang('report generator');
		Settings::getInstance()->update('flags', ['app_header' => $this->flags['app_header']]);
	...
	private function _validate_criteria()
	{
		...
		foreach ($restricted_values as $k => $field)
		{
			...
			{
				$criteria[] = array(
					'field'		 => $field, 'operator'	 => $operators[$k], 'value1'	 => trim($values_1[$k]),
					'conector'	 => $conector[$k]
				);
			}
		}
