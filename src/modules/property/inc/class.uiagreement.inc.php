...
//                $permission_update?array('key' => 'select',	'label' =>$table_header[13]['header'], 'sortable' => false, 'resizeable' => false, 'formatter'=>FormatterCheckItems):"",
		...
		function view_item()
		{
			...
			$myColumnDefs0 = array
				(
				array('key'		 => 'activity_id', 'label'		 => lang($table_header[0]['header']),
					'sortable'	 => true,
					'resizeable' => true),
				...
				array('key'		 => 'w_cost', 'label'		 => lang($table_header[3]['header']), 'sortable'	 => true,
					'resizeable' => true, 'formatter'	 => 'JqueryPortico.FormatterRight'),
				array('key'		 => 'total_cost', 'label'		 => lang($table_header[4]['header']),
					'sortable'	 => true,
					'resizeable' => true, 'formatter'	 => 'JqueryPortico.FormatterRight'),
				array('key'		 => 'this_index', 'label'		 => lang($table_header[5]['header']),
					'sortable'	 => true,
					'resizeable' => true),
				array('key'		 => 'index_count', 'label'		 => lang($table_header[6]['header']),
					'sortable'	 => true,
					'resizeable' => true, 'formatter'	 => 'JqueryPortico.FormatterCenter'),
				array('key'		 => 'index_date', 'label'		 => lang($table_header[7]['header']),
					'sortable'	 => true,
					'resizeable' => true)
			);
