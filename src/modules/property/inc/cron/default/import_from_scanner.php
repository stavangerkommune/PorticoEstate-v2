...
class import_from_scanner
{
	...
	var $bocommon, $bofiles, $db, $bolocation, $receipt, $botts, $currentrecord, $account, $userSettings, $phpgwapi_common;
					...
					if ($file_entry['type'] == 'Reklamasjon')
					{
						...
						else
						{
							if ($values['location_code'] = $this->get_location_code($file_entry['target']))
							{
								...
								$values['cat_id']		 = (isset($this->userSettings['preferences']['property']['tts_category']) ? $this->userSettings['preferences']['property']['tts_category'] : '');
								$values['priority']		 = (isset($this->userSettings['preferences']['property']['prioritydefault']) ? $this->userSettings['preferences']['property']['prioritydefault'] : '');
