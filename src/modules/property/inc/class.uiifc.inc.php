 ...
 * @package hrm
 */
class uiifc extends phpgwapi_uicommon_jquery
{
	...
	var $bo, $account, $cats, $nextmatchs, $allrows, $cat_id, $filter, $bocommon,
		$acl_location, $acl_read, $acl_add, $acl_edit, $acl_delete, $acl_manage, $_category_acl;
	...
	function __construct()
	{
		...
		$this->flags['menu_selection']	 = 'property::ifc';
	...
	function import()
	{
		...
		$this->flags['app_header']	 = lang('ifc') . ': ' . lang('import');
		//_debug_array($data);
	...
	function delete()
	{
		...
		$data = array(
			...
			'delete_action'			 => phpgw::link('/index.php', array(
				'menuaction' => 'property.uiifc.delete',
				'ifc_id'	 => $ifc_id
			)),
