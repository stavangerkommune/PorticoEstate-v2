...
class import_component_files
{
	...
	public function __construct()
	{
		...
		{
			$this->fakebase			 = '/temp_files_components';
			$this->path_upload_dir	 = $serverSettings['files_dir'] . $this->fakebase . '/';
		}
	...
	public function add_files_location()
	{
		...
		$uploaded_files			 = Cache::session_get('property', 'import_data');
		$this->paths_from_file	 = Cache::session_get('property', 'paths_from_file');
		...
		$component = array('id' => $this->location_item_id, 'location_id' => $this->location_obj->get_id('property', '.location.' . count(explode('-', $this->location_code))));
	...
	public function preview()
	{
		...
		Cache::session_set('property', 'paths_from_file', $this->paths_from_file);
		Cache::session_set('property', 'import_data', $relations);
	...
	public function add_files_components_location()
	{
		...
		$component_files		 = Cache::session_get('property', 'import_data');
		$this->paths_from_file	 = Cache::session_get('property', 'paths_from_file');
