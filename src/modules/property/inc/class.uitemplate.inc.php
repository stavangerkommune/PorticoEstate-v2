...
class property_uitemplate extends phpgwapi_uicommon_jquery
{
	...
	function __construct()
	{
		...
		$this->flags['menu_selection']	 = 'property::project::template';
		Settings::getInstance()->update('flags', ['xslt_app' => true, 'menu_selection' => 'property::project::template']);
		...
		$data = array(
			...
			'datatable'		 => array(
				...
				'field'			 => array(
					...
					array(
						'key'		 => 'building_part', 'hidden'	 => false, 'label'		 => lang('Building part'),
						'sortable'	 => true
					),
					array('key' => 'code', 'hidden' => false, 'label' => lang('Code'), 'sortable' => false),
					array(
						'key'		 => 'grouping_descr', 'hidden'	 => false, 'label'		 => lang('Grouping'),
						'sortable'	 => false
					),
					array(
						'key'		 => 'hours_descr', 'hidden'	 => false, 'label'		 => lang('Description'),
						'sortable'	 => false
					),
					array('key' => 'unit', 'hidden' => false, 'label' => lang('Unit'), 'sortable' => false),
					array(
						'key'		 => 'billperae', 'hidden'	 => false, 'label'		 => lang('Bill per unit'),
						'sortable'	 => true
					)
				)
			)
