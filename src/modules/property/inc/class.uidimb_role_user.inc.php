...
class property_uidimb_role_user extends phpgwapi_uicommon_jquery
{
	...
	function __construct()
	{
		...
		$this->flags['menu_selection']	 = 'admin::property::accounting::dimb_role_user2';
	...
	function index()
	{
		...
		$datatable_def[] = array(
			...
			'requestUrl' => json_encode(self::link(array(
				'menuaction'		 => 'property.uidimb_role_user.query',
		...
		$role_list	 = execMethod('property.bogeneric.get_list', array(
			'type'		 => 'dimb_role',
			'selected'	 => $role
		));
		$dimb_list	 = execMethod('property.bogeneric.get_list', array(
			'type'		 => 'dimb',
			'selected'	 => $dimb
		));
	...
	public function query()
	{
		...
		$values = $this->bo->read(array(
			'user_id'		 => $user_id, 'dimb_id'		 => $dimb_id,
	...
	public function edit()
	{
		...
		else
		{
			phpgw::redirect_link('/index.php', array(
				'menuaction' => 'property.uidimb_role_user.index',
