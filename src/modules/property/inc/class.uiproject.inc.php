<?php
	...
	class property_uiproject extends phpgwapi_uicommon_jquery
	{
		...
		public function handle_multi_upload_file()
		{
			...
			$options['script_url']	 = html_entity_decode(self::link(array('menuaction' => 'property.uiproject.handle_multi_upload_file',
					'id'		 => $id)));
		...
		public function build_multi_upload_file()
		{
			...
			$multi_upload_action = phpgw::link('/index.php', array('menuaction' => 'property.uiproject.handle_multi_upload_file',
				'id'		 => $id));
			...
			if (!$this->receipt['error'])
			{
				...
				if (!$this->receipt['error'])
				{
					...
					if (isset($GLOBALS['phpgw_info']['server']['smtp_server']) && $GLOBALS['phpgw_info']['server']['smtp_server'])
					{
						...
						$message = '<a href ="' . phpgw::link('/index.php', array('menuaction' => 'property.uiproject.edit',
						...
						if ($toarray)
						{
							...
							$body = '<a href ="' . phpgw::link('/index.php', array('menuaction' => 'property.uiproject.edit',
			...
			else
			{
				$budget_def = array
					...
					array('key'		 => 'deviation_percent_acc', 'label'		 => lang('percent') . '::' . lang('accumulated'),
						'sortable'	 => false, 'className'	 => 'right', 'formatter'	 => 'JqueryPortico.FormatterAmount2'),
					array('key'		 => 'closed', 'label'		 => lang('closed'), 'sortable'	 => false,
						'className'	 => 'center',
...
//				'external_project_data' => $external_project_data,
				...
				'location_item_id'					 => $id,
				'edit_action'						 => phpgw::link('/index.php', array('menuaction' => 'property.uiproject.edit',
					'id'		 => $id)),
...
//			$project = $this->bo->read_single($project_id);
		...
		function bulk_update_status()
		{
			...
			foreach ($list as &$entry)
			{
				...
				$entry['link'] = phpgw::link('/index.php', array('menuaction' => "property.ui{$type}.edit",
					'id'		 => $entry['id']));
			}
			...
			switch ($type)
			{
				case 'project':
					...
					$myColumnDefs			 = array
						...
						array('key' => 'title', 'label' => lang('title'), 'sortable' => true),
						array('key' => 'status', 'label' => lang('status'), 'sortable' => true),
						array('key'		 => 'num_open', 'label'		 => lang('open'), 'sortable'	 => true,
							'className'	 => 'right',
							'formatter'	 => 'JqueryPortico.FormatterAmount0'),
