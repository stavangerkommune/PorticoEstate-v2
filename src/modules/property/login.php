...
// start mapping
		if (isset($_POST['loginusertype']) && $_POST['loginusertype'] == 'tenant')
		{
			...
			$db->query(
				"SELECT fm_tenant.id, phpgw_accounts.account_lid,phpgw_accounts.account_pwd"
...
// end mapping
	...
	else if ($GLOBALS['phpgw_info']['server']['show_domain_selectbox'])
	{
	...
	$login_msg = lang('loginscreen_message');
	if ($login_msg != '!loginscreen_message')
	{
