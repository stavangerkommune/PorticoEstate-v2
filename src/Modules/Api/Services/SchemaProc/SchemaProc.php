	...
	*/
	class SchemaProc
	{
		...
		function __construct($dbms)
		{
			...
			{
				case 'mysql':
				$this->m_oTranslator	= new \App\Modules\Api\Services\SchemaProc\SchemaProcMysql();
				break;

				case 'postgres':
				$this->m_oTranslator	= new \App\Modules\Api\Services\SchemaProc\SchemaProcPgsql();
				break;

				case 'oracle':
				$this->m_oTranslator	= new \App\Modules\Api\Services\SchemaProc\SchemaProcOracle();
				break;

				case 'sapdb':
				$this->m_oTranslator	= new \App\Modules\Api\Services\SchemaProc\SchemaProcSapdb();
				break;

				case 'mssqlnative':
				case 'mssql':
				$this->m_oTranslator	= new \App\Modules\Api\Services\SchemaProc\SchemaProcMssql();
				break;

				default:
				//what now?
			}
			$this->m_oDeltaProc		= new \App\Modules\Api\Services\SchemaProc\SchemaProcArray();
