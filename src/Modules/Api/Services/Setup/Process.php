<?php
	...
	*/
	...
	use App\Modules\Api\Services\SchemaProc\SchemaProc;
...
//					&& file_exists($appdir.'default_records.inc.php'))
	...
	//		$GLOBALS['phpgw']->acl		= CreateObject('phpgwapi.acl');
			...
			//		$locations = $GLOBALS['phpgw']->locations->get_locations(false, $appname);
					$locations = (new \App\Modules\Api\Controllers\Locations())->get_locations(false, $appname);
			...
			{
				\App\Modules\Api\Services\Cache::user_clear('phpgwapi', 'menu', $account_id);
			}
		}
