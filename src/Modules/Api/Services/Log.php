<?php
 ...
 //   Use App\Helpers\Sanitizer;
	use App\Modules\Api\Services\LogMessage;
//	use App\Database\Db;
					...
					if ( isset($user['apps']['admin']) )
					{
						$trace = '<h2>' .lang('back trace') . "</h2>\n"
									. '<p>' . lang('Please include the following output when you report this incident on our bug tracker - %1',
											'<a href="https://github.com/PorticoEstate/PorticoEstate/issues" target="_blank">https://github.com/PorticoEstate/PorticoEstate/issues</a>') . "</p>\n"
									. '<pre>' . implode("\n", $msg_array) . '</pre>';
					}
				}
