...
//bb_event_targetaudience
	...
	function booking_upgrade0_2_64()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('bb_application', 'customer_organization_name',
				array(
					'type' => 'varchar',
					'precision' => '150',
					'nullable' => True
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('bb_application', 'customer_organization_id',
				array(
					'type' => 'int',
					'precision' => 4,
					'nullable' => True
...
//END temp fix Stavanger out of sync
	...
	function booking_upgrade0_2_77()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('bb_purchase_order', 'reservation_type',
			array(
				'type' => 'varchar',
				'precision' => 70,
				'nullable' => True
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('bb_purchase_order', 'reservation_id',
			array(
				'type' => 'int',
				'precision' => 4,
				'nullable' => True
...
HTML;
	...
	function booking_upgrade0_2_90()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_building', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_building', 'tilsyn_email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_building', 'tilsyn_email2',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_contact_person', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_organization', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_user', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_delegate', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		...
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_organization_contact', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		...
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_group_contact', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_event', 'contact_email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		...
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_system_message', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
		));
		$GLOBALS['phpgw_setup']->oProc->AlterColumn('bb_participant', 'email',
			 array(
				'type'		 => 'varchar',
				'precision'	 => 255,
				'nullable'	 => true
...
//			}
	...
	function booking_upgrade0_2_95()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('bb_resource', 'booking_buffer_deadline',
	...
	//	$oProc->m_odb->transaction_begin();
		...
		$oProc->AddColumn('bb_e_lock_system', 'webservicehost_',
				array('type' => 'text', 'nullable' => true)
			);
