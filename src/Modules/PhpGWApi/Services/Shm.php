...
*/
	...
	*/
	...
	if ( !isset($serverSettings['temp_dir'])  
			|| !is_dir($serverSettings['temp_dir']) )
	{
		if ( substr(PHP_OS,0, 3) == 'WIN' )
		{
			$serverSettings['temp_dir'] = 'c:/temp';
		}
		else
		{
			$serverSettings['temp_dir'] = '/tmp';
		}
	}
	...
	*/
	define('PHPGW_SHM_LOG_FILE', $serverSettings['temp_dir'] . '/phpgw-shm-debug.log' );
	...
	*/
	define('PHPGW_SHM_LOCK', $serverSettings['temp_dir']);
	...
	//		$shmid = sem_get($SHM_KEY, 1024, 0644 | IPC_CREAT);
		...
		*/
		public static function is_enabled()
		{
			...
			if ( isset($serverSettings['shm_enable'])
				&& $serverSettings['shm_enable'] )
			{
				$checked = true;
