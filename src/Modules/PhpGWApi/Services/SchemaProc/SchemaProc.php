	...
	*/
	class SchemaProc
	{
		...
		function __construct($dbms)
		{
			...
			{
				case 'mysql':
				$this->m_oTranslator	= new \App\Modules\PhpGWApi\Services\SchemaProc\SchemaProcMysql();
				break;

				case 'postgres':
				$this->m_oTranslator	= new \App\Modules\PhpGWApi\Services\SchemaProc\SchemaProcPgsql();
				break;

				case 'oracle':
				$this->m_oTranslator	= new \App\Modules\PhpGWApi\Services\SchemaProc\SchemaProcOracle();
				break;
			...
			$this->m_oDeltaProc		= new \App\Modules\PhpGWApi\Services\SchemaProc\SchemaProcArray();
